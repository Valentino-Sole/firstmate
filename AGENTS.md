...
state/               runtime records and signals; gitignored
  ...
  .resgate-cap-work .resgate-cap-home  durable manual resource-cap override markers forcing the 50% weekly-schedule cap immediately on the work or home PC regardless of the clock window; firstmate arms one or both directly on the captain's "Kappung"/"Kappung <host>", clears on "Kappung auf" (docs/configuration.md "Fleet resource governance")

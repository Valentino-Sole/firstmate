...
After compaction, continue the in-flight assignment immediately from the compact continuation note and recent turns.
Do not wait for the captain to say to resume, and do not re-read the session-start digest or AGENTS.md in full.

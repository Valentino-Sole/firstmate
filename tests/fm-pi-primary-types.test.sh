...
cp "$ROOT/.pi/extensions/fm-cursor-grok-model.ts" "$TMP_ROOT/fm-cursor-grok-model.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-cursor-grok-model.ts" "$TMP_ROOT/lib/fm-cursor-grok-model.ts"

...
phase_spawn() {
  ...
  assert_grep 'unset FM_ROOT_OVERRIDE FM_STATE_OVERRIDE FM_DATA_OVERRIDE FM_PROJECTS_OVERRIDE FM_CONFIG_OVERRIDE;' "$LOG" "launch did not unset the operational overrides"

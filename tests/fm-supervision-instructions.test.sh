...
test_conditional_stanzas() {
  ...
  assert_contains "$out" "- Captain language: keep captain-facing supervision summaries and status responses in German" \
    "captain-language hardening stanza missing"

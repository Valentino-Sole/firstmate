...
The reset leaves each variable genuinely unset rather than set to empty, because consumers distinguish the two, and it takes effect whatever login shell the pane runs, including fish.

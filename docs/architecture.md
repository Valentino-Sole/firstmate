...
For the separate Arbeits-PC inventory, [Klartext-Uebernahme isolation](klartext-uebernahme-isolation.md) owns the authorized read path, isolation contract, and PreToolUse guard.
